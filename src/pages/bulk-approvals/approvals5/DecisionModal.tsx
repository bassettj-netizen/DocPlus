...
// Message textarea, Cancel/Send footer. Always spells out exactly which
// document(s) are affected, whether this came from a single row's own
// buttons or the list's bulk bar.
