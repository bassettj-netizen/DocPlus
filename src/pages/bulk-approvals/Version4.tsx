...
import DocumentEditor from './version4/DocumentEditor'

// Everything for this version lives under /bulk-approvals/version-4 — this
...
export default function BulkApprovalsV4() {
  return (
    <Routes>
