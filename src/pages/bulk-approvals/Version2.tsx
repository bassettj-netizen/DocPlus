...
import DocumentEditor from './version2/DocumentEditor'

// Everything for this version lives under /bulk-approvals/version-2 — this
...
export default function BulkApprovalsV2() {
  return (
    <Routes>
