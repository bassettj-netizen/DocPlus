...
import DocumentEditor from './version6/DocumentEditor'

// Everything for this version lives under /bulk-approvals/version-6 — this
...
export default function BulkApprovalsV6() {
  return (
    <Routes>
