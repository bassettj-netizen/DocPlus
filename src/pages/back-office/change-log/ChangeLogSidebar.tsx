...
export default function ChangeLogSidebar({ collapsed, onCollapsedChange }: ChangeLogSidebarProps) {
  ...
  const topItems = [
    ...
    },
    {
      ...
      onClick: () => navigate('/back-office/legal-changes/home'),
    },
    {
      key: 'change-log',
      label: 'Change Log',
